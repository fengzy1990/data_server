				...
				if(XMLHttpReq.readyState==4){ //对象状态
					if(XMLHttpReq.status==200){//信息已成功返回，开始处理信息
						...
						if(XMLHttpReq.responseText!=""){				
							...
							if (res == "ok") {
								document.getElementById("status").innerHTML="该用户id可以使用！";
							} else {
								document.getElementById("status").innerHTML="该用户id已经存在！";
								window.alert("该用户id已经存在！");
							}
						}
		...
		<table height="100%" width="100%">
			<tr>
				<td align="center">
					...
					<table width="572" height="307" background="images/login.gif">
						<tr>
							<td width="60%"></td>
							<td>
								<form name="form1" action="users.do?method=adduser" method="post"
									...
									<table width="250" border="0">
										...
										<tr>
											<td>
												<span style="color: #C10202">*</span>登录名id：
											</td>
											<td>
