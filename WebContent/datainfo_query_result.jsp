				...
				<td align="left" valign="top">
					...
					<TABLE width="100%" class="position">
						<TR>
							<TD>当前位置：信息查询</TD>
							<TD align="right"><a
								href="datainfo.do?method=pagequery&pageSize=<%=pageSize%>&pageNo=<%=pageNo%>">返回查询界面</a>
							</TD>
							<TD width="20"></TD>
						</TR>
					</TABLE> <b></b>
					...
					<form name="form1" action="datainfo.do?method=pagequery" method="post">
